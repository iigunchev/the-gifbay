...
const Layout = ({ children = null }) => {
  ...
  return (
    <>
      <Head>
        <title>The GifBay</title>
        <meta
          name="title"
          content="Enjoy and share your favorite Gifs and Memes"
        />
            ...
            <div className="h-full px-4 flex justify-between items-center space-x-4">
              <Link href="/">
                <a className="flex items-center space-x-1">
                  <PhotographIcon className="shrink-0 w-8 h-8 text-rose-500" />
                  <span className="text-xl font-semibold tracking-wide">
                    The<span className="text-rose-600">GifBay</span>
                  </span>
                </a>
              </Link>
